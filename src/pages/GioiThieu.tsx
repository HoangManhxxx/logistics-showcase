                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <div className="space-y-4 text-muted-foreground">
                            <p>
                                Công ty TNHH DỊch vụ và Vận Tải Hoàng Phong được thành lập từ năm 2014, xuất phát từ
                                niềm đam mê và khát vọng xây dựng một đơn vị vận tải chuyên nghiệp, hiện đại tại Việt
                                Nam.
                            </p>
                            <p>Với đội ngũ hơn 100 nhân viên giàu kinh nghiệm cùng hệ thống xe đa dạng từ 5 tấn đến xe
                                siêu trường siêu trọng, chúng tôi cam kết đáp ứng mọi nhu cầu vận chuyển của khách
                                hàng.</p>
                            <p>
        ...
        <section className="py-16 lg:py-24 bg-secondary">
            <div className="container mx-auto">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    {values.map((item, index) => <div key={index}
                ...
                <div className="max-w-3xl mx-auto">
                    {milestones.map((item, index) => <div key={index} className="flex gap-6 mb-8 last:mb-0">
                        <div className="flex flex-col items-center">
                            <div
                                className="w-16 h-16 bg-accent rounded-full flex items-center justify-center font-heading font-bold text-accent-foreground">
                                {item.year}
                            </div>
