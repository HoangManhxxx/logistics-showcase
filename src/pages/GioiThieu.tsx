...
const stats = [
  { icon: Truck, value: "500+", label: "Phương tiện vận tải" },
  { icon: Users, value: "1000+", label: "Khách hàng tin tưởng" },
  { icon: Award, value: "15+", label: "Năm kinh nghiệm" },
  { icon: Shield, value: "100%", label: "Bảo hiểm hàng hóa" },
];
          ...
          <section className="relative py-20 lg:py-32">
            ...
            <div className="container mx-auto relative text-center">
              ...
              <p className="text-xl text-primary-foreground/80 max-w-2xl mx-auto">
                15+ năm kinh nghiệm trong ngành vận tải, phục vụ hàng ngàn khách hàng trên toàn quốc
              </p>
            </div>
          </section>
